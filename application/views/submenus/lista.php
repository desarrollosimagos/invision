                        ...
                        <?php foreach ($listar as $submenu) { ?>
                            <tr style="text-align: center">
                                ...
                                <td style='text-align: center'>
                                    <a href="<?php echo base_url() ?>submenus/edit/<?= $submenu->id; ?>" title="Editar"><i class="fa fa-edit fa-2x"></i></a>
                                </td>
                                <td style='text-align: center'>
                                    <a class='borrar' id='<?php echo $submenu->id; ?>' title='Eliminar'><i class="fa fa-trash-o fa-2x"></i></a>
                                </td>
                            </tr>
                            <?php $i++ ?>
                        <?php } ?>
