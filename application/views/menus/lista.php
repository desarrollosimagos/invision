                        ...
                        <?php foreach ($listar as $menu) { ?>
                            <tr style="text-align: center">
                                ...
                                <td style='text-align: center'>
                                    <a href="<?php echo base_url() ?>menus/edit/<?= $menu->id; ?>" title="Editar"><i class="fa fa-edit fa-2x"></i></a>
                                </td>
                                <td style='text-align: center'>
                                    
                                    <a class='borrar' id='<?php echo $menu->id; ?>' title='Eliminar'><i class="fa fa-trash-o fa-2x"></i></a>
                                </td>
                            </tr>
                            <?php $i++ ?>
                        <?php } ?>
